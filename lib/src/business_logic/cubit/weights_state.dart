...
final class WeightsCubitState extends Equatable {
  ...
  /// Returns the weight for today based on the last element in [WeightList]. Returns 0 if [WeightList] is empty.
  double get currentWeight => weightList.isEmpty ? 0 : weightList.last.weight;
